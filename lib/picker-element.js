...
module.exports = class PickerElement {
  ...
  build() {
    ...
    this.formatSelect = createElement("select", "input-select color-picker-format");
    this.formatSelect.setAttribute("aria-label", "Output format");
    ...
    definition.append(this.formatSelect, this.textInput);
  ...
  bindEvents(root) {
    ...
    this.listen(this.formatSelect, "change", () => {
